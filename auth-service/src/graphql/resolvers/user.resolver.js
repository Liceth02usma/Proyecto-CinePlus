...
module.exports = {
  ...
  updateUser: async (args) => {
    ...
    if (args.email) {
      const existingUser = await User.findOne({ email: args.email, _id: { $ne: args.id } });
      console.log(existingUser);
      if (existingUser) {
        console.log("Aquiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii")
    ...
    const userUpdate = await User.findByIdAndUpdate(args.id, args, { new: true });
